...
pub fn dlopen_fd(fd: BorrowedFd, flags: libc::c_int) -> anyhow::Result<LibraryHandle> {
...
pub fn dlsym(handle: LibraryHandle, symbol: &str) -> anyhow::Result<*const c_void> {
